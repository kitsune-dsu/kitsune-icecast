...
typedef struct _thread_type_tag { /* kitsune: gave the type a name */
...
typedef struct mutex_tag { /* kitsune: gave the type a name */
#ifdef DEBUG_MUTEXES
  ...
  pthread_mutex_t * E_OPAQUE sys_mutex; /**DSU xfgen */
} mutex_t;

typedef struct _cond_tag { /* kitsune: gave the type a name */
#ifdef THREAD_DEBUG
    long cond_id;
    char *name;
#endif

  pthread_mutex_t * E_OPAQUE cond_mutex; /**DSU xfgen */
  pthread_cond_t * E_OPAQUE sys_cond; /**DSU xfgen */
} cond_t;

typedef struct _rwlock_tag { /* kitsune: gave the type a name */
#ifdef THREAD_DEBUG
    long rwlock_id;
    char *name;
  ...
  pthread_rwlock_t * E_OPAQUE sys_rwlock; /**DSU xfgen */
} rwlock_t;
