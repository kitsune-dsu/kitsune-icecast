...
/* EKIDEN: */
struct avl_node_tag {
  void * E_T(@t)        key; /**DSU xfgen */
  struct avl_node_tag E_G(@t) *    left; /**DSU xfgen */
  struct avl_node_tag E_G(@t) *    right;   /**DSU xfgen */
  struct avl_node_tag E_G(@t) *    parent; /**DSU xfgen */
    /*
  ...
  typedef struct avl_node_tag E_G(@t) avl_node E_GENERIC(@t); /**DSU xfgen_ignore */
...
typedef struct _avl_tree {
  avl_node E_G(@t) *            root; /**DSU xfgen */
  unsigned long            height;
  unsigned long            length;
  avl_key_compare_fun_type    compare_fun;
  void * E_T(@c)             compare_arg; /**DSU xfgen */
#ifndef NO_THREAD
  rwlock_t rwlock;
#endif
} E_GENERIC(@t, @c); /**DSU xfgen */
  typedef struct _avl_tree E_G(@t, @c) avl_tree E_GENERIC(@t, @c); /**DSU xfgen_ignore */
