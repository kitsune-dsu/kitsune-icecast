...
typedef struct source_tag
{
  ...
  avl_tree E_G(client_t*,[opaque]) *client_tree; /**DSU xfgen */
  avl_tree E_G(client_t*,[opaque]) *pending_tree; /**DSU xfgen */

    rwlock_t *shutdown_rwlock;
    util_dict *audio_info;

  FILE * E_OPAQUE intro_file; /**DSU xfgen_add */

  char *dumpfilename; /* Name of a file to dump incoming stream to */
  FILE * E_OPAQUE dumpfile; /**DSU xfgen */
